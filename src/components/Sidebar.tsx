...
const Sidebar = () => {
  return (
    <nav className="w-full md:max-w-[280px] bg-indigo-300 md:h-screen font-bold text-2xl md:p-[20px] py-[10px] px-[15px] text-[#36454F]">
      <div className="gap-y-5 flex md:block items-center justify-between">
        <div>
          <Link
            to="/"
            className="flex items-center text-black md:text-3xl md:mb-[30px]"
          >
            <h1 className="mb-[10px]">Dashboard</h1>
          </Link>
        </div>
